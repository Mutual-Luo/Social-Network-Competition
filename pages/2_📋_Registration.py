...
Each team will be assigned a unique team ID as the sole identifier for submissions, 
so please refrain from disclosing your team ID to others to avoid unnecessary complications.
"""
)
